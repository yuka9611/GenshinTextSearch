...
from entity_constants import (
    # 大分类
    SOURCE_TYPE_ITEM, SOURCE_TYPE_FOOD, SOURCE_TYPE_FURNISHING, SOURCE_TYPE_GADGET,
    SOURCE_TYPE_COSTUME, SOURCE_TYPE_SUIT, SOURCE_TYPE_WEAPON, SOURCE_TYPE_RELIQUARY,
    SOURCE_TYPE_MONSTER, SOURCE_TYPE_CREATURE, SOURCE_TYPE_MATERIAL, SOURCE_TYPE_BLUEPRINT,
    SOURCE_TYPE_GCG, SOURCE_TYPE_NAMECARD, SOURCE_TYPE_PERFORMANCE, SOURCE_TYPE_AVATAR_INTRO,
    SOURCE_TYPE_DRESSING, SOURCE_TYPE_MUSIC_THEME, SOURCE_TYPE_OTHER_MAT, SOURCE_TYPE_AVATAR_MAT,
    ...
    # 二级分类
    SUB_NONE, SUB_QUEST_ITEM, SUB_FURN_BLUEPRINT, SUB_CARD_FACE, SUB_CARD, SUB_CONSUMABLE,
    SUB_AVATAR_INTRO, SUB_CONSTELLATION, SUB_SUITE_BLUEPRINT, SUB_CHEST, SUB_EVENT_ITEM,
    SUB_WIDGET, SUB_SEED, SUB_CARD_BACK, SUB_EVENT_FOOD, SUB_WOOD, SUB_EXP_MATERIAL,
    SUB_COSTUME_DRESS, SUB_TRACE, SUB_FLYCLOAK_SUB, SUB_FIREWORKS, SUB_FISH_ROD,
    SUB_WEAPON_SKIN, SUB_PROFILE_FRAME, SUB_PROFILE_PICTURE, SUB_GCG_BOX, SUB_FISH_BAIT,
    SUB_BGM, SUB_BREAKTHROUGH, SUB_QIANXING_PARADOX, SUB_QIANXING_SUIT,
    # 映射与标签
